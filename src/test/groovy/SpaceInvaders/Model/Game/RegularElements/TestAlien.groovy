...
class TestAlien extends Specification {
    ...
    def "getScore"(){
        given:
            def alien = new Alien(Mock(Position),30,20,20,AlienState.PASSIVE,0)
    ...
    def "IncreaseScore"(){
        given:
            ...
            def alienState = AlienState.ATTACKING
            def alien = new Alien(position,100,50,initialScore,alienState,0)
    ...
    def "SetScore"(){
        given:
            def alien = new Alien(Mock(Position),20,20,20,AlienState.PASSIVE,0)
    ...
    def "SetAlienState"(){
        given:
            def alien = new Alien(Mock(Position),20,20,20,AlienState.ATTACKING,0)
    ...
    def "Test Alien type bigger or equal to 3" (){
        given:
            def position = Mock(Position)
            def alienState = AlienState.ATTACKING
            def alien = new Alien(position,100,50,0,alienState,3)
            def alien2 = new Alien(position,100,50,0,alienState,4)
